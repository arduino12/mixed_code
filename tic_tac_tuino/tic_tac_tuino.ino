...
#define RGB_COLOR_MAGENTA	(RGB_COLOR_BLUE	| RGB_COLOR_RED)
...
void refresh() {
	...
	for(uint16_t i = 0b000000001; i <= 0b100000000; i *= 2) {
		...
		digitalWrite(GREEN_LED_PIN,	(i & green_leds_mask)	!= 0);
